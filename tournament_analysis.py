...
def main():
    ...
    test_agents = [
        Agent(AlphaBetaPlayer(score_fn=custom_score, m_factor= 10000), "AB_Custom"),
        Agent(AlphaBetaPlayer(score_fn=custom_score, m_factor= 100), "AB_Custom_2"),
        Agent(AlphaBetaPlayer(score_fn=custom_score, m_factor= 1), "AB_Custom_3"),
        Agent(AlphaBetaPlayer(score_fn=custom_score, m_factor= 1/100), "AB_Custom_4"),

    ]

    cpu_agents = [
        Agent(AlphaBetaPlayer(score_fn=custom_score, m_factor= 1), "AB_Custom_1")
    ]
